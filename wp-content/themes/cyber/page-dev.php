		...
		<div class="work-process">
			<div class="work-process__icon-slider">
				<div class="work-process__icon-slider--arrows">
					<div class="work-process__icon-slider--arrow work-process__icon-slider--arrow-prev"
					     data-wp-arrow-prev>
					...
					<div class="work-process__icon-slider--arrow work-process__icon-slider--arrow-next"
					     data-wp-arrow-next>
						<svg width="4" height="8" viewBox="0 0 4 8" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="work-process__icon-slider--carousel" data-wp-icon-slider>
					<div class="work-process__icon-slider--item">
						<div>
							<img src="<?= get_template_directory_uri(); ?>/images/wp-icon1.svg" alt="icon">
							<h4>
								Брифинг
							</h4>
						</div>
			...
			<div class="work-process__text-slider">
				<div class="work-process__text-slider--carousel" data-wp-text-slider>
					<div class="work-process__text-slider--item">
						<h3 class="section-title">
							Как мы работаем
						</h3>
						<p>
							После получения вашего интереса к нашей организации,
							мы планируем наше первое взаимодействие.
							Наш член команды проведет подробный разговор с вами,
							чтобы понять ваши чаяния и требования
						</p>
					</div>
					<div class="work-process__text-slider--item">
						<h3 class="section-title">
						...
						<p>
							...
							Totam rerum deserunt non tenetur aspernatur. Dolorem.
						</p>
					</div>
					<div class="work-process__text-slider--item">
						<h3 class="section-title">
						...
						<p>
							Voluptatum molestiae, necessitatibus debitis totam,
							ratione esse temporibus non nisi aperiam ex impedit sunt eum voluptatem quibusdam.
							Molestiae eum quas dicta eius!
						</p>
					</div>
				</div>
			</div>
