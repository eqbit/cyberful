...
$(function () {
  if (document.querySelector('#typed')) {
    var typed = new Typed('#typed', {
      strings: ['современный продуманный дизайн', 'качественная работа на мобильных устройствах', 'интуитивно понятная административная панель', 'от 20 000 ₽ за полноценный одностраничный сайт-визитку', 'от 40 000 ₽ за многостраничный корпоративный сайт'],
      startDelay: 500,
      typeSpeed: 60,
      loop: true,
      backSpeed: 20,
